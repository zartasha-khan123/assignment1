...
function BookEvent() {
  ...
  return (
    ...
    <section className="flex-grow flex flex-col items-center justify-center p-4 mb-16">
...
<div className='flex items-center justify-center space-x-4 mb-9'>
    <button className="bg-red-300 border-spacing-6 rounded-lg px-4 py-2 text-black" > Book Now </button>
      ...
      <a
        ...
        className="text-gray-600 hover:text-pink-600 transition duration-300 border-6 rounded-lg px-4 py-2 mt-5 md:mt-10 text-center" 
      >
        <FaInstagram className="w-8 h-8" />
      </a>
   
    </div>
    <div className="flex flex-col items-center justify-center min-h-screen bg-pink-100 mt-10">
...
<h1 className='from-neutral-600 font-extrabold text-orange-600 text-2xl mt-6'>
      ...
      <div className="relative w-full max-w-2xl p-6 bg-green-300 rounded-lg shadow-lg ">
        ...
        <div className="relative overflow-hidden rounded-lg ">
          < Image
            ...
            className="w-full h-48 md:h-64 object-cover transition-transform duration-500 ease-in-out "
